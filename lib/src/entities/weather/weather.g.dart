...
_$_WeatherParams _$_$_WeatherParamsFromJson(Map<String, dynamic> json) {
  return _$_WeatherParams(
...
Map<String, dynamic> _$_$_WeatherParamsToJson(_$_WeatherParams instance) =>
    <String, dynamic>{
      'temp': instance.temp,
